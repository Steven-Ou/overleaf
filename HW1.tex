...
I used a Python program to calculate what happens after 500 iterations. The program is based on a gradient descent formula. And I got $x \approx 0.693$. 
\vspace{5mm}

\intermediatesubproblem{If you had to guess, what value do you think our algorithm in Problem 4 Part $(c)$ will converge to?}
\\\\
I would've guessed the value would've been 0.680 because that is around the graph I sketched above.
\vspace{5mm}
...
\\\\
As the iterations continue, the learning rate starts to decrease and decrease and become even smaller. 
\vspace{5mm}
\intermediatesubproblem{If you had to guess, what value do you think our algorithm in Problem 4 Part $(f)$ will converge to?}
\\\\
It would've converged to a number that is smaller than -1. 
\vspace{5mm}

\intermediatesubproblem{Do you think that in using gradient descent the starting point matters?}
Yes, when using gradient descent the starting point matters because if you use 0 it will go nowhere and will remain at 0. 
\end{enumerate}
