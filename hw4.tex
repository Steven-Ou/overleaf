...
% --- List Item Styling (for 1., 2., etc. within problems) ---
% Label color will be DarkText due to global \color{DarkText}
\setlist[enumerate,1]{label=\textbf{\arabic*.}, itemsep=0.5ex, topsep=0.5ex}
\setlist[enumerate,2]{label=\textbf{\alph*).}, itemsep=0.5ex, topsep=0.5ex} % For potential sub-questions
...
\section*{Problem 1} % Reverted to \section* with manual numbering in title
...
\end{enumerate}
\newpage
\section*{Problem 2} % Reverted to \section* with manual numbering in title
...
% Students would draw on the image or provide a new one.
...
\section*{Problem 3} % Reverted to \section* with manual numbering in title
...
\vspace{30mm}
\section*{Problem 4} % Reverted to \section* with manual numbering in title
...
\section*{Problem 5} % Reverted to \section* with manual numbering in title
