...
\\\\\underline{Weights (layer 1 to Hidden Layer 1 and 2):}\\ $w_{11}^{[1]} =0.3 , w_{12}^{[1]} =0.1 , w_{13}^{[1]}=0.5 , w_{21}^{[1]}=0.2 ,w_{22}^{[1]}=0.6 , w_{23}^{[1]} =0.15$ \\
\underline{Biases (Hidden Layer 1 and 2):}\\
$b_{1}^{[1]}=0.8 , b_{2}^{[1]} =-1.4$\\
\underline{Weights (Hidden Layer to Output Layer):}//
$w_{11}^{[2]} =0.2 , w_{12}^{[2]} =0.6$\\
